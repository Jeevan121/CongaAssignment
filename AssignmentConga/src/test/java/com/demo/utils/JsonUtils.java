...
public class JsonUtils extends BaseTest{
	...
	public HashMap<String, String> getFramedJsonReqMap(String externalId,String name){
	
		HashMap reqMap = new HashMap();
		
		reqMap.put("external_id", externalId);
		reqMap.put("name",name);
		reqMap.put("latitude", 33.33);
		reqMap.put("longitude", -111.43);
		reqMap.put("altitude",444);
